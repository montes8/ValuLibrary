package com.valu.valulibrary.ui.home.importations
...
@Composable
fun ImportsScreen(paddingValues: PaddingValues,viewModel: AppViewModel = koinViewModel()) {

    val products = viewModel.listProductsImports
    LaunchedEffect(Unit) {
